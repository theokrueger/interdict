...
Thus, the crucial hypothesis of Interdict is that frustration and friction is the antithesis of addictive apps, while silently and subtly throttling your connection will not alert the user to the actions being taken by Interdict. Causing this frustration won't tell you to stop scrolling, it will make you *want* to.
